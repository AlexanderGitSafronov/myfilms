    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-10">
          {[
            { href: "/add-movie", icon: Film, label: "Добавить фильм", color: "from-red-600 to-red-800" },
            { href: "/lists", icon: List, label: "Мои списки", color: "from-zinc-700 to-zinc-900" },
            { href: "/profile", icon: Users, label: "Мой профиль", color: "from-zinc-700 to-zinc-900" },
    ...
    <div className="relative overflow-hidden">
      ...
      <div className="relative z-20 max-w-4xl mx-auto px-4 sm:px-6 pt-24 pb-16 text-center">
        ...
        <h1 className="text-5xl sm:text-6xl font-bold text-white leading-tight mb-6">
          Делитесь любимыми фильмами<br />
          <span className="text-red-500">с друзьями</span>
        </h1>
      ...
      <div className="relative z-20 max-w-6xl mx-auto px-4 sm:px-6 py-20">
        <div className="grid sm:grid-cols-3 gap-6">
          {[
            ...
            { icon: Film, title: "Поиск", desc: "Ищите фильмы через TMDB — автоматически получайте название, постер, рейтинг и жанры." },
